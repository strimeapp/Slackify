...
class TestCase extends \PHPUnit_Framework_TestCase
{
    ...
    public function getApiSearchMock($token)
    {
        $api = $this->getMockBuilder('Strime\Slackify\Api\Search')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function getApiStarsMock($token)
    {
        $api = $this->getMockBuilder('Strime\Slackify\Api\Stars')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function getApiUserGroupsMock($token)
    {
        $api = $this->getMockBuilder('Strime\Slackify\Api\UserGroups')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function getApiUsersMock($token)
    {
        $api = $this->getMockBuilder('Strime\Slackify\Api\Users')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function getApiUsersProfileMock($token)
    {
        $api = $this->getMockBuilder('Strime\Slackify\Api\UsersProfile')
            ->disableOriginalConstructor()
            ->getMock();
